...
CcZnp.prototype._scheduleNextSend = function (criteria) {
    var txQueue = this._txQueue;

    if (txQueue.length) {
        var entry
        if(criteria){
            var entryIndex = txQueue.findIndex(function(){
                return criteria.subsys != entry.subsys || criteria.cmd != entry.cmd
            });
