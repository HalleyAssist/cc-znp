...
class Pipeline {
    ...
    async __execute(cancellationState, argObj, deferred, logging = true){
        ...
        let timer
        try {
            deferred.startTimeout = ()=>{
                cancellationState.promiseWrap(Q.timeout(deferred.promise, 2200).catch((ex) => {
            ...
            assert(typeof execution.cancel === 'function', "execution should be cancellable")
